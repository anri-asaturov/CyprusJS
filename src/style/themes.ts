...
const baseTheme = {
  ...
  themeSwitchTransition: 'color 0.5s, background 1.2s ease, border 1.4s, box-shadow 1.4s;',
  headerHeight: '5rem',
...
//-- LIGHT THEME
const lightThemeProps: Partial<Theme> = { name: 'LIGHT' };

export const lightTheme = Object.assign({}, baseTheme, lightThemeProps);

//-- DARK THEME
const darkThemeProps: Partial<Theme> = {
  name: 'DARK',
  logoUrl: whiteLogo,
